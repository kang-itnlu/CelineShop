                                            ...
                                            <form role="form"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control" value="${blog.id}">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <!-- Date dd/mm/yyyy -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="blog_category" class="form-control" value="${blog.blog_category}">
                                                    </div>
                                                    <!-- /.input group -->
                                                </div>
                                                <div class="form-group">
                                            ...
                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid rgb(221, 221, 221); padding: 10px; display: none;" >${blog.des}</textarea>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="image" class="custom-file-input" id="customFile" value="${blog.image}">
