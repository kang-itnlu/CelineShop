                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a
                                    href="${pageContext.request.contextPath}/Admin/product/image-add">Quản lý ảnh</a></li>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-md-6">
                                    <div class="card card-info">
                                        ...
                                        <div class="card-body">
                                            <form role="form" action="${pageContext.request.contextPath}/Admin/product/image-add?id=${id}" method="post">
                                                <!-- Date dd/mm/yyyy -->
                                                <!-- /.form group -->
                                                <!-- phone mask -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="button" value="Tải ảnh lên"  onclick="BrowseServer();" class="btn btn-controls" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="button" value="Tải ảnh lên"  onclick="BrowseServer1();" class="btn btn-controls" />
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="button" value="Tải ảnh lên"  onclick="BrowseServer2();" class="btn btn-controls" />
